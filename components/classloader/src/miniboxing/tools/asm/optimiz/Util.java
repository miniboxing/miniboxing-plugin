...
import miniboxing.tools.asm.Type;
import miniboxing.tools.asm.Label;
import miniboxing.tools.asm.ClassWriter;
import miniboxing.tools.asm.MethodWriter;

import miniboxing.tools.asm.tree.AbstractInsnNode;
import miniboxing.tools.asm.tree.InsnNode;
import miniboxing.tools.asm.tree.LdcInsnNode;
import miniboxing.tools.asm.tree.LabelNode;
import miniboxing.tools.asm.tree.MethodInsnNode;
import miniboxing.tools.asm.tree.ClassNode;
import miniboxing.tools.asm.tree.MethodNode;
import miniboxing.tools.asm.tree.FieldNode;
import miniboxing.tools.asm.tree.VarInsnNode;
import miniboxing.tools.asm.tree.InsnList;
import miniboxing.tools.asm.tree.LocalVariableNode;
import miniboxing.tools.asm.tree.TryCatchBlockNode;
import miniboxing.tools.asm.tree.JumpInsnNode;

import miniboxing.tools.asm.util.Textifier;
...
public class Util {
    ...
    public static String textify(final ClassNode cnode) {
      miniboxing.tools.asm.util.TraceClassVisitor trace = new miniboxing.tools.asm.util.TraceClassVisitor(new java.io.PrintWriter(new java.io.StringWriter()));
      cnode.accept(trace);
    ...
    public static String textify(final AbstractInsnNode insn) {
        miniboxing.tools.asm.util.TraceMethodVisitor trace = new miniboxing.tools.asm.util.TraceMethodVisitor(new Textifier());
        insn.accept(trace);
        java.io.StringWriter sw = new java.io.StringWriter();
        java.io.PrintWriter  pw = new java.io.PrintWriter(sw);
        trace.p.print(pw);
