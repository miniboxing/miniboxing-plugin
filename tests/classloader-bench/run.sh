...
echo Running generic tester...
../../mb-scala $@ -cp jars/miniboxing-classloader-assembly-0.1-SNAPSHOT.jar:jars/miniboxing-runtime-assembly-0.1-SNAPSHOT.jar:./vector-nosp/:./binaries/tester-nosp-bin/ miniboxing.classloader.test.TestNoSp
