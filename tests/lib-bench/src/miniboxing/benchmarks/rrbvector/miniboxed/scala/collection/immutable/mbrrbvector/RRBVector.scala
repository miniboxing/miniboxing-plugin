...
final class RRBVector[@miniboxed +A] private[immutable](override private[immutable] val endIndex: Int) extends Traversable[A] with TraversableLike[A, RRBVector[A]] with Iterable[A] with IterableLike[A, RRBVector[A]] with RRBVectorPointer[A@uncheckedVariance] with Serializable {
  self =>
...
class RRBVectorIterator[@miniboxed +A](startIndex: Int, override private[immutable] val endIndex: Int) extends Iterator[A] with RRBVectorPointer[A@uncheckedVariance] {
    ...
    private[collection] final def initIteratorFrom[@miniboxed B >: A](that: RRBVectorPointer[B]): Unit = {
...
class RRBVectorReverseIterator[@miniboxed +A](startIndex: Int, final override private[immutable] val endIndex: Int) extends Iterator[A] with RRBVectorPointer[A@uncheckedVariance] {
...
private[immutable] trait RRBVectorPointer[@miniboxed A] {
    private[immutable] final var display0: MbArray[A] = _
    ...
    private[immutable] final def initWithFocusFrom(that: RRBVectorPointer[A]): Unit = {
        initFocus(that.focus, that.focusStart, that.focusEnd, that.focusDepth, that.focusRelax)
        initFrom(that)
    }

    private[immutable] final def initFocus[@miniboxed U](focus: Int, focusStart: Int, focusEnd: Int, focusDepth: Int, focusRelax: Int): Unit = {
        this.focus = focus
    ...
    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A]): Unit = {
        this.depth = 1
        this.display0 = display0
    }

    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A], display1: Array[AnyRef]): Unit = {
        this.depth = 2
        this.display0 = display0
        this.display1 = display1
    }

    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A], display1: Array[AnyRef], display2: Array[AnyRef]): Unit = {
        this.depth = 3
        this.display0 = display0
        this.display1 = display1
    ...
    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef]): Unit = {
        this.depth = 4
        this.display0 = display0
        this.display1 = display1
        this.display2 = display2
    ...
    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef], display4: Array[AnyRef]): Unit = {
        this.depth = 5
        this.display0 = display0
        this.display1 = display1
        this.display2 = display2
    ...
    private[immutable] final def initFromDisplays[@miniboxed U](display0: MbArray[A], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef], display4: Array[AnyRef], display5: Array[AnyRef]): Unit = {
        this.depth = 6
        this.display0 = display0
        this.display1 = display1
    ...
    private[immutable] final def initFrom(that: RRBVectorPointer[A]): Unit = {
        if (RRBVector.compileAssertions) {
            assert(that != null)
        }
        depth = that.depth
    ...
    private[immutable] final def initSingleton(elem: A): Unit = {
        initFocus(0, 0, 1, 1, 0)
    ...
    private[immutable] final def makeTransientSizes(oldSizes: MbArray[Int], transientBranchIndex: Int): MbArray[Int] = {
