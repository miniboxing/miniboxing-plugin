...
import miniboxing.benchmarks.tuples.miniboxed_hardcoded.TuplesQuickSort
...
trait HardcodedMiniboxedBenchTest extends BaseTest {
  ...
  def testHardcodedMiniboxed() = {
    ...
    test("miniboxed_hardcoded", "quicksort_array_of_tuples", _ => (),  TuplesQuickSort.quicksortByKey[Int](arr), () => {})
  }
}
