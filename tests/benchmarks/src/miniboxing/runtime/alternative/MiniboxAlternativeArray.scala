...
class MiniboxArray_NoInline {
  ...
  def mbarray_new(len: Int, tag: Byte): Any = tag match {
   ...
   def mbarray_apply_minibox(array: Any, idx: Int, tag: Byte): Long = tag match {
   ...
   def mbarray_update_minibox(array: Any, idx: Int, value: Long, tag: Byte): Unit = tag match {
  ...
  def mbarray_update_box[T](array: Any, idx: Int, value: T, tag: Byte): Unit = tag match {
...
object MiniboxArray_SemiSwitch {
  ...
  @inline final def mbarray_new(len: Int, tag: Byte): Any =
    if (tag % 2 == 0) {
      tag match {
        case UNIT =>     new Array[Unit](len)
        case BYTE =>     new Array[Byte](len)
  ...
  @inline final def mbarray_apply_minibox(array: Any, idx: Int, tag: Byte): Long =
    if (tag % 2 == 0) {
      tag match {
        case UNIT =>    array.asInstanceOf[Array[Unit]](idx); 0
        case BYTE =>    array.asInstanceOf[Array[Byte]](idx).toLong
  ...
  @inline final def mbarray_update_minibox(array: Any, idx: Int, value: Long, tag: Byte): Unit =
    if (tag % 2 == 0) {
      tag match {
        case UNIT =>    array.asInstanceOf[Array[Unit]](idx) = ()
        case BYTE =>    array.asInstanceOf[Array[Byte]](idx) = value.toByte
  ...
  @inline final def mbarray_update_box[T](array: Any, idx: Int, value: T, tag: Byte): Unit = ???
