...
import miniboxing.runtime.MiniboxArray_NoInline._
    ...
    try {
      ...
      case _: NullPointerException =>
        try {
          ...
          val clazz = classloader.findClass("miniboxing.benchmarks.hardcoded.noinline.MBResizableArrayFactoryInstance_" + T_TypeTag)
